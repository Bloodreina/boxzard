	...
	insert into tbUsuario values
		('Alex Celestino',   '45662809852', 2, 1),
		('Amanda Aparecida', '98158914802', 3, 2),
		('Gustavo Caires',   '90924574852', 4, 3),
		('João Pedro',       '33709259827', 5, 4),
		('Lais da Silva',    '11753546869', 8, 5),
		('BoxZard',          '42233370848', 7, 6),
		('Alex Buarque',   	 '47586727848', 1, 7)
	;
