function next(direction){
    ...
    if(pagina == 1){
        ...
        if(direction=='front'){
            ...
            if(nome.value == '' || email.value == '' || senha.value == '' || confirmar_senha.value == ''){
        ...
        if(direction=='front'){
            ...
            if(cpf.value == '' || local.value == '' || numero_casa.value == '' || complemento.value == ''){
                ...
                var aux = valida_cpf_cnpj(cpf.value);
...
//Inicio Script validar CPF ou CNPJ
    
    // Função verificar cpf e cnpj
    ...
    */
    function valida_cpf_cnpj ( valor ) {
        ...
        // Não retorna nada
            ...
            swal("Atenção", "CPF ou CNPJ inválidos", "warning");
        }
...
//Fim Script validar CPF ou CNPJ
